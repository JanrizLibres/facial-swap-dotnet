...
namespace FaceSwapWinform
{
    ...
    public struct Triangle(Point p1, Point p2, Point p3)
    {
        /// <summary>
        ...
        public readonly Point2f[] ToPoint2f()
        {
            return
            [
                new(P1.X, P1.Y),
    ...
    public struct Warp(Triangle source, Triangle destination)
    {
        /// <summary>
        /// The source triangle to warp from.
        /// </summary>
        public Triangle Source = source;

        /// <summary>
        /// The destination triangle to warp to.
        /// </summary>
        public Triangle Destination = destination;
    }
    ...
    public static class Utility
    {
        ...
        public static Mat ApplyWarps(System.Drawing.Bitmap sourceImage, int width, int height, IEnumerable<Warp> warps)
        {
            ...
            foreach (var warp in warps)
            {
                ...
                Mat img1Cropped = new(r1.Size, source.Type());
